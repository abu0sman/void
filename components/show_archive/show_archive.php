...
echo '<div id="d_unblock_archive" class="modal"></div>';
...
echo "<input type='hidden' id='find_string' value='$find_string'>";
	...
	//Основная часть
	echo '<div id="show_archive_current"></div>';
...
echo "<script>
	...
	$.ajax({
		...
		url: '../show_archive/show_archive_current.php',
		type: 'POST',
		cache: false,
		success: function(result){
			$('#show_archive_current').html(result);
		}
	});
</script>";
