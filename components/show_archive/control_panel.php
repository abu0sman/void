...
echo '<div id="control_panel" class="form-inline">';
	...
	echo '<button id="b_unblock_archive" class="btn btn-outline-success btn-sm mr-1" title="Извлечь ордер из архива">
		<span class="ui-icon ui-icon-unlocked"></span></button>';
