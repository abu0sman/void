...
echo "<h2 class='h2'>Архивная " . $data_pattern[0]['pattern']. ": $actual_order «" . $topic . "» </h2>";
	...
	//echo '<script src="../show_archive/comments_and_files.js"></script>';
	echo '<script src="../show_archive/control_panel.js"></script>';
	echo '<script src="../show_archive/show_scripts.js"></script>';
	echo '<script src="../show_archive/show_refresh.js"></script>';
