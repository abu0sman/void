...
if(isset($_POST['b_confirm_unblock_order'])){
	$actual_order = $_POST['actual_order'];
	$query_arch_order = "UPDATE `m_orders` SET `state` = 1 WHERE `id` = '$actual_order';";
...
/* if(isset($_POST['b_confirm_edit_order'])){
	$actual_order = $_POST['actual_order'];
	$topic = $_POST['topic'];
	$resolution = $_POST['resolution'];
