...
for(var iters=0; iters<30; iters++){
	...
	var	page_code_4 = "$.ajax({url: '../shop_order/shop_order_current.php', data: {page_id: page_id, find_string: find_string, ch_pe:'yes'}, type: 'POST', cache: false, success:  function(result){$('#shop_order_current').html(result);} })";
	var page_code_5 = "});";
